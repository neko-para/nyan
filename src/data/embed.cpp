...
DECLARE_PROGRAM_DATA(kill)
DECLARE_PROGRAM_DATA(test)

namespace nyan::data {

EmbedProgram programs[6] = {
    DECLARE_PROGRAM(sh),   DECLARE_PROGRAM(true), DECLARE_PROGRAM(false),
    DECLARE_PROGRAM(echo), DECLARE_PROGRAM(kill), DECLARE_PROGRAM(test),
};
